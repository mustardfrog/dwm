...
//static const char *fonts[]          = {  "Input Mono: size=10", "fontawesome: size=14" };
static const char *fonts[]          = { "Ubuntu Mono: size=13"," Font Awesome: size=19"};
static const char dmenufont[]       = "Ubuntu Mono: size=13";
static const char col_gray1[]       = "#000000";
static const char col_gray2[]       = "#b4be82";
static const char col_gray3[]       = "#89e8dd";
static const char col_gray4[]       = "#89b8c2";
static const char col_cyan[]        = "#2a3158";
