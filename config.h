...
static const char *fonts[]          = {  "Ubuntu:size=11","monospace:size=10", "fontawesome: size=10", "Oxygen: size=10""Inconsolata: size=14", "SpaceMono:size=10", "Mukta:size=14"};
